...
from manager.models import Employee, Client, EnquiryClient, AirPort, AirTicket, Islamic, Tour, Visa, PackageIslamic, PackageTour, PackageAirTicket, PackageVisa, Order, Expenditure
...
class ClientForm(ModelForm):
    class Meta:
        model   = Client
        exclude  = ('actual_price','created_by',)        
        widgets = {
...
class EnquiryClientForm(ModelForm):
    class Meta:
        ...
        widgets = {
                ...
                'special_requirment': forms.TextInput(attrs={'class':'form-control'}),
...
class OrderForm(ModelForm):
    class Meta:
        model   = Order
        exclude  = ('created_by','client','package_tour','package_islamic','package_air_ticket','package_visa','actual_price',)   
        widgets = {
                ...
                'payable_ammount'    : forms.NumberInput(attrs={'class':'form-control','min':'0'}),                
                'received_ammount'   : forms.NumberInput(attrs={'class':'form-control','min':'0'}),
                'due_ammount'        : forms.NumberInput(attrs={'class':'form-control','min':'0'}),                
                'ship_to'             : forms.TextInput(attrs={'class':'form-control'}),
                'ship_to_company_name': forms.TextInput(attrs={'class':'form-control'}),
                'ship_to_address'     : forms.TextInput(attrs={'class':'form-control'}),
                'ship_to_phone'       : forms.TextInput(attrs={'class':'form-control'}),
...
class ExpenditureForm(ModelForm):
    class Meta:
        ...
        exclude  = ('created_at',) 
        widgets = {
                'recieved_by'      : forms.TextInput(attrs={'class':'form-control'}),
